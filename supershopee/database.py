...
def init_db():
    ...
    if curr.execute("SELECT COUNT(*) FROM products").fetchone()[0] == 0:
        products = [
            ...
            ("Artisan Whole Wheat Bread", "Bakery", 4.49, 60,
            ...
            ("Organic Carrots 2lb", "Produce", 2.99, 200,
            ...
            ("Greek Yogurt 500g", "Dairy", 5.49, 100,
            ...
            ("Natural Almond Butter", "Pantry", 7.99, 50,
            ...
            ("Free-Range Eggs (Dozen)", "Dairy", 6.99, 120,
            ...
            ("Cherry Tomatoes", "Produce", 3.99, 100,
            ...
            ("Whole Grain Pasta 500g", "Pantry", 2.79, 200,
            ...
            ("Honeycrisp Apples", "Produce", 1.49, 250,
            ...
            ("Aged Cheddar Cheese", "Dairy", 7.49, 75,
             "https://images.unsplash.com/photo-1555939594-58d7cb561537?q=80&w=500&auto=format&fit=crop",
             "Sharp aged cheddar with rich, complex flavor."),
            ("Fresh Baby Spinach 200g", "Produce", 3.49, 80,
             "https://images.unsplash.com/photo-1511537190424-f06628ca66d5?q=80&w=500&auto=format&fit=crop",
             "Tender baby spinach packed with iron and nutrients."),
            ("Wild-Caught Salmon Fillet", "Seafood", 12.99, 40,
             "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=500&auto=format&fit=crop",
             "Premium wild-caught salmon rich in omega-3 fatty acids."),
            ("Long Grain Brown Rice 2lb", "Pantry", 3.99, 150,
             "https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=500&auto=format&fit=crop",
             "Nutty brown rice with a satisfying, chewy texture."),
            ("Fresh Blueberries", "Produce", 5.99, 60,
             "https://images.unsplash.com/photo-1599599810694-a5f899da9e47?q=80&w=500&auto=format&fit=crop",
             "Antioxidant-rich blueberries, perfect for smoothies."),
            ("Premium Olive Oil 500ml", "Pantry", 11.99, 40,
             "https://images.unsplash.com/photo-1502224311726-72d15d3c5c16?q=80&w=500&auto=format&fit=crop",
             "Extra virgin olive oil with fruity, aromatic notes."),
            ("Fresh Croissants (6-pack)", "Bakery", 5.99, 30,
             "https://images.unsplash.com/photo-1585854870192-e5cd83cf7b73?q=80&w=500&auto=format&fit=crop",
             "Buttery, flaky French croissants fresh from our oven."),
            ("Ripe Avocados", "Produce", 2.49, 120,
             "https://images.unsplash.com/photo-1541519227354-08fa5d50c44d?q=80&w=500&auto=format&fit=crop",
             "Creamy avocados ready for guacamole and salads."),
            ("Wholesome Granola Cereal", "Pantry", 5.49, 90,
             "https://images.unsplash.com/photo-1585518895894-94ccb9e9b3b6?q=80&w=500&auto=format&fit=crop",
             "Wholesome granola packed with seeds and nuts."),
            ("Fresh Broccoli Crowns", "Produce", 2.99, 110,
             "https://images.unsplash.com/photo-1564617278893-a0ff63e35e6c?q=80&w=500&auto=format&fit=crop",
             "Vibrant green broccoli crowns, perfect for steaming or roasting."),
        ]
